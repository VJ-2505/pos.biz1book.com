...
export class ModifyoptionComponent implements OnInit {
  ...
  // product: any;
  unmappedConfig: { CategoryId: any }
  mappedConfig: { CategoryId: any }
  ...
  ngOnInit() {
    this.unmappedConfig = { CategoryId: "all" }
    this.mappedConfig = { CategoryId: "all" }
    this.Getstore();
    // this.getmapedproduct();
    setHeightWidth();
  ...
  setUMConfig(e) {
    ...
    this.unmappedConfig = { CategoryId: +e.target.value }
  }
  setMConfig(e) {
    console.log(e, e.target.value)
    this.mappedConfig = { CategoryId: +e.target.value }
  }
  saveOption() {
