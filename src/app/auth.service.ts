...
export class AuthService {
  ...
  getpendingorder(CompanyId, storeId) {
    return this.http.get(this.base_url + "POSOrder/Getpendingorder?CompanyId=" + CompanyId + "&storeId=" + storeId);
  }
  getOrderId(orderid) {
    return this.http.get(this.base_url + "POSOrder/GetOrderId?orderid=" + orderid);
  }
  getTransactionId(orderid) {
    return this.http.get(this.base_url + "POSOrder/GetTransactionId?orderid=" + orderid);
  }
  getKotInspect(storeId, CompanyId, MinQty, RemainingHrs) {
    return this.http.get(this.base_url + "POSOrder/GetKotInspect?storeId=" + storeId + "&CompanyId=" + CompanyId + "&MinQty=" + MinQty + "&RemainingHrs=" + RemainingHrs);
  }
  GetKOTInspectdetail(orderid) {
    return this.http.get(this.base_url + "POSOrder/GetKOTInspectdetail?orderid=" + orderid);
  }
  // getoptionprd(optionGroupId) {
  //   var formURL = this.base_url;
  //   var formURL =
  //     this.base_url +
  //     "OptionGroup/getMapedProducts?optionGroupId=" + optionGroupId;
  //   return this.http.get(formURL);
  ...
  getProduct(id, compId) {
    ...
    let options = new RequestOptions({ headers: headers });
    var formURL = this.base_url;
    var formURL = this.base_url + "Product/GetById?id=" + id + "&compId=" + compId;
    return this.http.get(formURL);
  }
  getTag(compId) {
    var formURL =
  ...
  prdactive(Id, active) {
    return this.http.get(this.base_url +"Product/UpdateAct?Id=" + Id + "&active=" + active);
  }
  getpaymt() {
    var formURL = this.base_url;
    var formURL =
